            ...
            <div class="table" >
                <table >
                    ...
                    <tr>
                        ...
                        <td>Succesful projects</td>
                        <td>Towards innovation</td>
                    </tr>
...
<div class="gallery">
   <div class="heading">
       <h1>Projects that might spark your interest</h1>
...
<div class="gallery-container">
    ...
    <div class="card">
       <img src="../assets/Gallery.png" alt="Idea 1">
       <div class="card-description">
           ...
           <div class="author">
               <div class="circle-button" ></div>
                ...
                <p>Designed for those who appreciate timeless elegance.</p>
           <div class="tags">
               <button>Product design</button>
               <button>Khorezm</button>
           </div>
       </div>
   </div>

   <div class="card">
       <img src="../assets/Gallery.png" alt="Idea 2">
       <div class="card-description">
           <h3>Elevate Your Typing: Meet the Wooden Keyboard</h3>
           <div class="author">
               <div class="circle-button" ></div>
   ...
   <div class="card">
       <img src="../assets/Gallery.png" alt="Idea 3">
       <div class="card-description">
           <h3>Elevate Your Typing: Meet the Wooden Keyboard</h3>
           <div class="author">
               <div class="circle-button" ></div>
...
<div class="gallery">
       <div class="heading">
           <h1>Explore different projects at various stages</h1>
           <div class="dropdown">
            <button class="dropdown-button">Close to target <i class="fa-sharp fa-solid fa-caret-down"></i></button>
            <div class="dropdown-content">
               <a href="#">Close to target</a>
               <a href="#">Just started</a>
               <a href="#">Charities</a>
               <a href="#">With rewards</a>
               <a href="#">Donation-based</a>
            </div>
         </div>
...
<!-- blogs  -->
    ...
    <div class="gallery">
       <div class="heading">
           <h1>Dive into blogs for expanding knowledge and learning best practices </h1>
...
<div class="gallery-container">
   ...
   <div class="blog">
        <img src="../assets/sign.png" alt="blog 1">    
        <a href="#">Lorem ipsum</a>  
    </div>

    <div class="blog">
        <img src="../assets/sign.png" alt="blog 2">    
        <a href="#">Lorem ipsum</a>  
    </div>

    <div class="blog">
        <img src="../assets/sign.png" alt="blog 3">    
        <a href="#">Lorem ipsum</a>  
    </div>
...
<div class="last-container">
    <div class="container">
        ...
        <div class="footer-content">
                <p>Uzbekistan's first and only crowdfunding platform. <br>
                Let's empower talented individuals, together. </p>

                <div class="table">
                    <table>
                        <tr>
                        <td><i class="fa-regular fa-face-smile"></i>With rewards</td>
                        <td><i class="fa-solid fa-fire-flame-curved"></i>Trending projects</td>
                        <td><i class="fa-regular fa-pen-to-square"></i>Tips for starting a project </td>
                        </tr>

                        <tr>
                        <td><i class="fa-solid fa-hand-holding-dollar"></i>Donation-based</td>
                        <td><i class="fa-regular fa-circle-question"></i>FAQ</td>
                        <td><i class="fa-solid fa-layer-group"></i>Categories</td>
                        </tr>

                        <tr>
                            <td><i class="fa-solid fa-wallet"></i>Interest-based </td>
                            <td><i class="fa-solid fa-headphones"></i>Careers</td>
                            <td><i class="fa-regular fa-star"></i>Inspiration</td>
                        </tr>

                        <tr>
                            <td><i class="fa-solid fa-suitcase"></i>Equity-based </td>
                            <td><i class="fa-regular fa-message"></i>Help & Support</td>
                            <td><i class="fa-solid fa-book"></i>Blogs</td>
                        </tr>
                    </table>
...
.start-button {
    ...
    border-radius: 11px;
    border-width: 1px;
    background-image: linear-gradient(to right, #FFCD25 , #FF6508);
    color: #fff;
    padding: 10px 5px;
...
.start-button:hover {
    background-image: linear-gradient(to right, #FFCD25 , #FFCD25);
...
.circle-button {
  ...
  background-image: url('../assets/profile_circle.png');
  background-size: cover;
  background-position: center;
  color: #fff;
  cursor: pointer;
